...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_default_values = function() {
      ...
      this.single_temp = new Template('<a href="javascript:void(0)" class="chzn-single chzn-default"><' + this.selected_item_tag + '>#{default}</' + this.selected_item_tag + '><div><b></b></div></a><div class="chzn-drop" style="left:-9000px;"><div class="chzn-search"><input type="text" autocomplete="off" /></div><ul class="chzn-results"></ul></div>');
      ...
      this.choice_temp = new Template('<li class="search-choice" id="#{id}"><' + this.selected_item_tag + '>#{choice}</' + this.selected_item_tag + '><a href="javascript:void(0)" class="search-choice-close" rel="#{position}"></a></li>');
    ...
    Chosen.prototype.results_build = function() {
      ...
      if (this.is_multiple && this.choices > 0) {
        ...
        this.selected_item.addClassName("chzn-default").down(this.selected_item_tag).update(this.default_text);
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (data.group) {
          ...
          if (data.selected && this.is_multiple) {
            ...
            this.selected_item.removeClassName("chzn-default").down(this.selected_item_tag).update(data.html);
    ...
    Chosen.prototype.results_reset = function() {
      ...
      this.selected_item.down(this.selected_item_tag).update(this.default_text);
      if (!this.is_multiple) {
    ...
    Chosen.prototype.result_select = function(evt) {
      ...
      if (this.result_highlight) {
        ...
        if (this.is_multiple) {
          ...
          this.selected_item.down(this.selected_item_tag).update(item.html);
          if (this.allow_single_deselect) {
            this.single_deselect_control_build();
          }
        }
    ...
    Chosen.prototype.single_deselect_control_build = function() {
      if (this.allow_single_deselect && !this.selected_item.down("abbr")) {
        return this.selected_item.down(this.selected_item_tag).insert({
